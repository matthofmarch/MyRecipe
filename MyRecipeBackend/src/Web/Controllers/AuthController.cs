...
namespace MyRecipe.Web.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        private readonly SpaLinksConfiguration _spaLinksConfiguration;
        ...
        public AuthController(
            ...
            IOptions<SpaLinksConfiguration> spaLinks,
            IApplicationDbContext dbContext)
        {
            _userManager = userManager;
            _signInManager = signInManager;
            _emailSender = emailSender;
            _spaLinksConfiguration = spaLinks.Value;
        ...
        public async Task<IActionResult> ResetPassword(string email)
        {
            ...
            var callbackUrl =
                $"{_spaLinksConfiguration.ResetPasswordBaseLink}?userId={WebUtility.UrlEncode(user.Id)}&token={WebUtility.UrlEncode(token)}";
        ...
        public async Task<IActionResult> ChangeEmail(string newEmail)
        {
            ...
            var callbackUrl =
                $"{_spaLinksConfiguration.ResetEmailBaseLink}" +
